...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PklInput) DeepCopyInto(out *PklInput) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PklInput.
func (in *PklInput) DeepCopy() *PklInput {
	if in == nil {
		return nil
	}
	out := new(PklInput)
...
func (in *PklInput) DeepCopyObject() runtime.Object {
